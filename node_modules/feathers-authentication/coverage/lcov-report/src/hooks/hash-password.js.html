...
<html lang="en">
<head>
    <title>Code coverage report for src/hooks/hash-password.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/hooks</a> hash-password.js
    </h1>
    <div class='clearfix'>
...
87
88
89</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof hashPw !== 'function') {
<span class="cstat-no" title="statement not covered" >      return Promise.reject(new Error(`'hash' must be a function that takes a password and returns Promise that resolves with a hashed password.`));</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (hook.data === undefined) {
<span class="cstat-no" title="statement not covered" >      debug(`hook.data is undefined. Skipping hashPassword hook.`);</span>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Nov 07 2016 21:44:08 GMT-0700 (MST)
</div>
</div>
