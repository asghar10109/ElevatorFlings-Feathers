...
<html lang="en">
<head>
    <title>Code coverage report for src/service.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> service.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  create (data = <span class="branch-1 cbranch-no" title="branch not covered" >{}, params = <span class="branch-1 cbranch-no" title="branch not covered" >{}) {</span></span>
    const defaults = this.app.get('authentication') || <span class="branch-1 cbranch-no" title="branch not covered" >this.app.get('auth');</span>
...
<span class="cstat-no" title="statement not covered" >      throw new Error(`You must provide a 'path' in your authentication configuration or pass one explicitly.`);</span>
    }
&nbsp;
...
&nbsp;
    if (typeof service.filter === 'function') {
      service.filter(<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >() =&gt; false);</span></span>
    }
  };
}
&nbsp;
