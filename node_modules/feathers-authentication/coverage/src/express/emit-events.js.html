...
<html lang="en">
<head>
    <title>Code coverage report for src/express/emit-events.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/express</a> emit-events.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    if (method === 'remove') {
      event = 'logout';
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (method === 'create') {
      event = 'login';
    }
&nbsp;
