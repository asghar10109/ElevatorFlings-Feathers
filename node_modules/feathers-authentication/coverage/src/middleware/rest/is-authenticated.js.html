...
<html lang="en">
<head>
    <title>Code coverage report for src/middleware/rest/is-authenticated.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/middleware/rest</a> is-authenticated.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (req.authenticated || req.feathers.authenticated) {
